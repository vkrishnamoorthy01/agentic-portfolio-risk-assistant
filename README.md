...
*Note: this project's code, tests, and documentation were drafted with AI tools in the loop, Claude Code, Sonnet 5, OpenAI Codex, and GPT-6 Astra, among them. The modeling choices and judgment calls are mine, and so are the errors.*
